...
--
-- Database: `identifying_fraudulent`
--
CREATE DATABASE IF NOT EXISTS `identifying_fraudulent` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `identifying_fraudulent`;
...
('9yhuarc88n9ng3ko1k1wx4je6uao495l', 'eyJ1c2VyaWQiOjF9:1su9gU:FPF6ABA15u66pYyUOGojmR7yycS0APlRWeDmriPbduY', '2024-10-11 12:02:54.888201'),
('b10agetqysfocilervvaq4dvj2kkyzzn', 'eyJ1c2VyaWQiOjJ9:1oWGy2:Cmg-qMmV26lOin1p5gmdgY0EJjUIllyQI8Mke9XYk8k', '2022-09-22 12:49:14.204104'),
...
('d7093bdmism9p1n5elsadnaularlyyah', 'eyJ1c2VyaWQiOjF9:1oQSw2:BxZIt1WaF4dz6Akje-_HX1kPy7DnvKiE_orp8WTC19M', '2022-09-06 12:23:10.482644'),
('dodtj8rp1ys0ixk25f0uubzwpulz0309', 'eyJ1c2VyaWQiOjJ9:1oQknG:HfhIARWi1kBPNOczXVBTTclhIqVEJkzP_VK-MlSP7KE', '2022-09-07 07:27:18.764259'),
...
('gqnc0csv0ehqzhisc4jxjpd0lz8b3dxw', 'eyJ1c2VyaWQiOjN9:1qwKvO:924iOx5-9T-mwvG-LS_f3iu1gWIZ781iAiKOCoHuMT4', '2023-11-10 11:22:46.895820'),
...
('t83b1dc9dzkf2o5314ia5olt4glwx4pe', 'eyJ1c2VyaWQiOjR9:1qwLwA:AB5PC-fz4NxQ4N9_H15gehj1n9S65J4w3-EJVtcAFy4', '2023-11-10 12:27:38.400981'),
...
('untauk0dmnemi65ssv47im9mg1q2gy7g', 'eyJ1c2VyaWQiOjF9:1oWEd1:soMzO3QkPCn2NGPlh_eHn-UjLnj62pGcHUJJRxB4M2Y', '2022-09-22 10:19:23.174136'),
...
('y8b1c307gz7sqb4ngjsy7i164azntrcs', 'eyJ1c2VyaWQiOjJ9:1suA0g:wZ66LFOJpaLSXXZxTwX6XCrQNga7od0ZNTcy0w43CLg', '2024-10-11 12:23:46.650288'),
...
(1, 'Ragava', 'Ragava123@gmail.com', 'Ragava', '9535866270', 'India', 'Karnataka', 'Bangalore', '', ''),
...
(5, 'Naive Bayes', '50.0'),
(6, 'SVM', '52.13675213675214'),
(7, 'Random Forest Classifier', '55.769230769230774'),
(8, 'Gradient Boosting Classifier', '51.70940170940172');
...
(6, 'Fraudulent Found', '50.0'),
(7, 'Fraudulent Not Found', '50.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_detect_fraudulent_cc_transactions`
--

CREATE TABLE IF NOT EXISTS `remote_user_detect_fraudulent_cc_transactions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(3000) NOT NULL,
  `Trans_Date` varchar(3000) NOT NULL,
  `CC_No` varchar(3000) NOT NULL,
  `CC_type` varchar(3000) NOT NULL,
  ...
  `lat` varchar(3000) NOT NULL,
  `lon` varchar(3000) NOT NULL,
  `Transid` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `remote_user_detect_fraudulent_cc_transactions`
--

INSERT INTO `remote_user_detect_fraudulent_cc_transactions` (`id`, `Fid`, `Trans_Date`, `CC_No`, `CC_type`, `Trans_Type`, `Amount`, `Firstname`, `Lastname`, `Gender`, `Age`, `lat`, `lon`, `Transid`, `Prediction`) VALUES
(1, '10.42.0.151-10.42.0.1-5732-53-17', '21-04-22', '4512830000000000000', 'First Wealth Credit Card ', 'entertainment', '2407.246035', 'Monica', 'Cohen', 'Female', '42', '39.8936', '-79.7856', '720000', 'Fraudulent Not Found'),
(2, '175.100.207.231-10.42.0.211-80-37025-6', '14-02-23', '6011390000000000', 'Single Currency Card', 'home', '311.963409', 'Natalie', 'Watson', 'Female', '61', '34.0443', '-118.2509', '420850', 'Fraudulent Found'),
(3, '10.42.0.211-23.206.173.182-55689-80-6', '16-01-22', '4457730000000000000', 'EaseMyTrip', 'personal_care', '100.302262', 'Stanley', 'Mayo', 'Male', '69', '38.5234', '-120.6763', '815000', 'Fraudulent Found'),
(4, '184.86.36.20-10.42.0.151-443-33700-6', '10-09-21', '3600000000000000', 'EaseMyTrip', 'entertainment', '140.983193', 'David', 'Everett', 'Male', '62', '41.0001', '-78.2357', '744000', 'Fraudulent Not Found');
